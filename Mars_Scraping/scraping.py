...
def mars_hemispheres(browser):
    ...
    mars_base_url = 'https://data-class-mars-hemispheres.s3.amazonaws.com/Mars_Hemispheres/'
    def mars_child_page (link_end):
        mars_abs_url = f'{mars_base_url}{link_end}'
        browser.visit(mars_abs_url)
        html = browser.html
